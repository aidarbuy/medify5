    ...
    (function() {
        ...
        function() {
            b.module("uiGmapgoogle-maps.providers").factory("uiGmapMapScriptLoader", ["$q", "uiGmapuuid", function(c, d) {
                var e, f;
                return f = void 0, e = function(a) {
                    return a.china ? "http://maps.google.cn/maps/api/js?" : "https://maps.googleapis.com/maps/api/js?"
                }, {
                    load: function(g) {
                        var h, i, j, k;
                        return h = c.defer(), b.isDefined(a.google) && b.isDefined(a.google.maps) ? (h.resolve(a.google.maps), h.promise) : (j = g.callback = "onGoogleMapsReady" + Math.round(1e3 * Math.random()), a[j] = function() {
                            a[j] = null, h.resolve(a.google.maps)
                        }, i = _.map(g, function(a, b) {
                            return b + "=" + a
                        }), f && document.getElementById(f).remove(), i = i.join("&"), k = document.createElement("script"), f = "ui_gmap_map_load_" + d.generate(), k.id = f, k.type = "text/javascript", k.src = e(g) + i, document.body.appendChild(k), h.promise)
                    }
                }
            ...
            b.module("uiGmapgoogle-maps.extensions").service("uiGmapExtendGWin", function() {
                return {
                    init: _.once(function() {
                        ...
                        }, a.MarkerLabel_.prototype.onRemove = function() {
        ...
        function() {
            ...
            }]).service("uiGmap_async", ["$timeout", "uiGmapPromise", "uiGmapLogger", "$q", "uiGmapDataStructures", "uiGmapGmapUtil", function(a, b, c, d, e, f) {
                var g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w;
                return v = b.promiseTypes, o = b.isInProgress, u = b.promiseStatus, g = b.ExposedPromise, i = b.SniffedPromise, p = function(a, b) {
                    var d;
                    return d = a.promise(), d.promiseType = a.promiseType, d.$$state && c.debug("promiseType: " + d.promiseType + ", state: " + u(d.$$state.status)), d.cancelCb = b, d
                }, l = function(a, b) {
                    return a.promiseType === v.create && b.promiseType !== v["delete"] && b.promiseType !== v.init ? (c.debug("lastPromise.promiseType " + b.promiseType + ", newPromiseType: " + a.promiseType + ", SKIPPED MUST COME AFTER DELETE ONLY"), !0) : !1
                }, t = function(a, b, d) {
                    var e;
                    return b.promiseType === v["delete"] && d.promiseType !== v["delete"] && null != d.cancelCb && _.isFunction(d.cancelCb) && o(d) && (c.debug("promiseType: " + b.promiseType + ", CANCELING LAST PROMISE type: " + d.promiseType), d.cancelCb("cancel safe"), e = a.peek(), null != e && o(e)) ? e.hasOwnProperty("cancelCb") && _.isFunction(e.cancelCb) ? (c.debug("promiseType: " + e.promiseType + ", CANCELING FIRST PROMISE type: " + e.promiseType), e.cancelCb("cancel safe")) : c.warn("first promise was not cancelable") : void 0
                }, h = function(a, b, c) {
                    var d, f;
                    if (a.existingPieces) {
                        if (d = _.last(a.existingPieces._content), l(b, d)) return;
                        return t(a.existingPieces, b, d), f = g(d["finally"](function() {
                            return p(b, c)
                        })), f.cancelCb = c, f.promiseType = b.promiseType, a.existingPieces.enqueue(f), d["finally"](function() {
                            return a.existingPieces.dequeue()
                        })
                    }
                    return a.existingPieces = new e.Queue, a.existingPieces.enqueue(p(b, c))
                }, r = function(a, b, d, e, f) {
                    var g;
                    return null == d && (d = ""), g = function(a) {
                        return c.debug("" + a + ": " + a), e(a)
                    }, h(a, i(f, b), g)
                }, j = 80, n = {
                    value: null
                }, w = function(a, b, c) {
                    ...
                    try {
                        ...
                        return d = e, n.value = d, n
                    }
                }, q = function(a, b, d, e) {
                    var f, g;
                    return g = w(a, b, e), g === n && (f = "error within chunking iterator: " + n.value, c.error(f), d.reject(f)), "cancel safe" === g ? !1 : !0
                }, k = function(b, c, d, e, f, g, h) {
                    var i, j, l;
                    for (i = c && c < b.length ? c : b.length, j = h, l = !0; l && i-- && j < (b ? b.length : j + 1);) l = q(e, void 0, g, [b[j], j]), ++j;
                    if (b) {
                        if (!(l && j < b.length)) return g.resolve();
                        if (h = j, c) return null != f && _.isFunction(f) && q(f, void 0, g, []), a(function() {
                            return k(b, c, d, e, f, g, h)
                        }, d, !1)
                    }
                }, m = function(a, d, e, f, g, h) {
                    var i, l, m;
                    return null == e && (e = j), null == g && (g = 0), null == h && (h = 1), m = void 0, l = b.defer(), m = l.promise, h ? void 0 === a || (null != a ? a.length : void 0) <= 0 ? (l.resolve(), m) : (k(a, e, h, d, f, l, g), m) : (i = "pause (delay) must be set from _async!", c.error(i), l.reject(i), m)
                }, s = function(a, c, d, e, f, g) {
                    var h;
                    return h = [], null != a && (null != a ? a.length : void 0) > 0 ? m(a, function(a) {
                        return h.push(c(a))
                    ...
                    each: m,
                    map: s,
                    managePromiseQueue: r,
                    promiseLock: r,
                    defaultChunkSize: j,
                    chunkSizeFrom: function(a) {
                        var b;
                        return b = void 0, _.isNumber(a) && (b = a), (f.isFalse(a) || a === !1) && (b = !1), b
                    }
                }
            }])
        }.call(this),
        ...
        function() {
            b.module("uiGmapgoogle-maps.directives.api.utils").service("uiGmapEventsHelper", ["uiGmapLogger", function() {
                return {
                    setEvents: function(a, c, d, e) {
                        return b.isDefined(c.events) && null != c.events && b.isObject(c.events) ? _.compact(_.map(c.events, function(f, g) {
                            var h;
                            return e && (h = _(e).contains(g)), c.events.hasOwnProperty(g) && b.isFunction(c.events[g]) && !h ? google.maps.event.addListener(a, g, function() {
                                return c.$evalAsync || (c.$evalAsync = function() {}), c.$evalAsync(f.apply(c, [a, g, d, arguments]))
                            }) : void 0
                        })) : void 0
                    },
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api.utils").factory("uiGmapFitHelper", ["uiGmapBaseObject", "uiGmapLogger", "uiGmap_async", function(a, b, d) {
                var e;
                return e = function(a) {
                    function b() {
                        return b.__super__.constructor.apply(this, arguments)
                    }
                    return c(b, a), b.prototype.fit = function(a, b) {
                        var c, e;
        ...
        function() {
            b.module("uiGmapgoogle-maps.directives.api.utils").service("uiGmapGmapUtil", ["uiGmapLogger", "$compile", function(a, c) {
                ...
                return e = function(a) {
                    ...
                    createWindowOptions: function(e, f, g, h) {
                        var i;
                        return null != g && null != h && null != c ? (i = b.extend({}, h, {
                            content: this.buildContent(f, h, g),
                            position: null != h.position ? h.position : b.isObject(e) ? e.getPosition() : d(f.coords)
                        }), null != e && null == (null != i ? i.pixelOffset : void 0) && (null == i.boxClass || (i.pixelOffset = {
                            height: 0,
                            width: -2
                    ...
                    defaultDelay: 50,
                    isTrue: function(a) {
                        return b.isDefined(a) && null !== a && a === !0 || "1" === a || "y" === a || "true" === a
                    },
                    isFalse: function(a) {
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api.utils").factory("uiGmapLinked", ["uiGmapBaseObject", function(a) {
                var b;
                return b = function(a) {
                    function b(a, b, c, d) {
        ...
        function() {
            b.module("uiGmapgoogle-maps.directives.api.utils").service("uiGmapLogger", ["$log", function(a) {
                ...
                }, d = {}, ["log", "info", "debug", "warn", "error"].forEach(function(a) {
                    return function(f) {
                        return d[f] = function(d) {
                            return a.doLog ? e(b[f], a.currentLevel, function() {
                                return c(f, d)
                            }) : void 0
                        }
                    }
                }(this)), this.LEVELS = b, this.currentLevel = b.error, this.log = d.log, this.info = d.info, this.debug = d.debug, this.warn = d.warn, this.error = d.error, this
            }])
        }.call(this),
        function() {
            var a = function(a, b) {
            ...
            b.module("uiGmapgoogle-maps.directives.api.utils").factory("uiGmapModelKey", ["uiGmapBaseObject", "uiGmapGmapUtil", "uiGmapPromise", "$q", "$timeout", function(b, c) {
                var e;
                return e = function(b) {
                    function e(b) {
                        this.scope = b, this.destroy = a(this.destroy, this), this.setChildScope = a(this.setChildScope, this), this.getChanges = a(this.getChanges, this), this.getProp = a(this.getProp, this), this.setIdKey = a(this.setIdKey, this), this.modelKeyComparison = a(this.modelKeyComparison, this), e.__super__.constructor.call(this), this.defaultIdKey = "id", this.idKey = void 0
                    }
                    return d(e, b), e.prototype.evalModelHandle = function(a, b) {
                        return void 0 === a || void 0 === b ? void 0 : "self" === b ? a : c.getPath(a, b)
                        ...
                        return c.equalCoords(this.evalModelHandle(a, d.coords), this.evalModelHandle(b, d.coords))
                        ...
                        return e
                    }, e.prototype.scopeOrModelVal = function(a, b, c, d) {
                        var e, f, g, h;
                    ...
                    }, e.prototype.setChildScope = function(a, b, c) {
                        return _.each(a, function(a) {
                            return function(d) {
                                var e, f;
                                return e = a.scopeOrModelVal(d, b, c, !0), e.isScope || (f = e.value, f === b[d]) ? void 0 : b[d] = f
                            }
                        }(this)), b.model = c
        ...
        function() {
            ...
            c = ["get", "put", "remove", "values", "keys", "length", "push", "didValueStateChange", "didKeyStateChange", "slice", "removeAll", "allVals", "allKeys", "stateChanged"], a.PropMap = function() {
                function a() {
                    this.removeAll = d(this.removeAll, this), this.slice = d(this.slice, this), this.push = d(this.push, this), this.keys = d(this.keys, this), this.values = d(this.values, this), this.remove = d(this.remove, this), this.put = d(this.put, this), this.stateChanged = d(this.stateChanged, this), this.get = d(this.get, this), this.length = 0, this.dict = {}, this.didValsStateChange = !1, this.didKeysStateChange = !1, this.allVals = [], this.allKeys = []
                }
                return a.prototype.get = function(a) {
                    return this.dict[a]
                }, a.prototype.stateChanged = function() {
                ...
                }, a.prototype.valuesOrKeys = function(a) {
                    var b, c;
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api.managers").factory("uiGmapClustererMarkerManager", ["uiGmapLogger", "uiGmapFitHelper", "uiGmapPropMap", function(c, e, f) {
                var g;
                return g = function(e) {
                    function g(b, d, e, h) {
                        null == d && (d = {}), this.opt_options = null != e ? e : {}, this.opt_events = h, this.checkSync = a(this.checkSync, this), this.getGMarkers = a(this.getGMarkers, this), this.fit = a(this.fit, this), this.destroy = a(this.destroy, this), this.clear = a(this.clear, this), this.draw = a(this.draw, this), this.removeMany = a(this.removeMany, this), this.remove = a(this.remove, this), this.addMany = a(this.addMany, this), this.update = a(this.update, this), this.add = a(this.add, this), g.__super__.constructor.call(this), this.type = g.type, this.clusterer = new NgMapMarkerClusterer(b, d, this.opt_options), this.propMapGMarkers = new f, this.attachEvents(this.opt_events, "opt_events"), this.clusterer.setIgnoreHidden(!0), this.noDrawOnSingleAddRemoves = !0, c.info(this)
                    }
                    return d(g, e), g.type = "ClustererMarkerManager", g.prototype.checkKey = function(a) {
                        var b;
                    ...
                    }, g.prototype.clearEvents = function(a) {
                        var d, e, f;
                        if (b.isDefined(a) && null != a && b.isObject(a)) {
                            f = [];
                            for (e in a) d = a[e], a.hasOwnProperty(e) && b.isFunction(a[e]) ? (c.info("" + optionsName + ": Clearing event: " + e + " to clusterer"), f.push(google.maps.event.clearListeners(this.clusterer, e))) : f.push(void 0);
                            return f
                        }
                        ...
                        return g.__super__.fit.call(this, this.getGMarkers(), this.clusterer.getMap())
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api.managers").factory("uiGmapMarkerManager", ["uiGmapLogger", "uiGmapFitHelper", "uiGmapPropMap", function(b, c, e) {
                var f;
                return f = function(f) {
                    function g(c) {
                    ...
                    return d(g, f), g.include(c), g.type = "MarkerManager", g.prototype.add = function(a, c) {
                        var d, e;
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api.options.builders").service("uiGmapCommonOptionsBuilder", ["uiGmapBaseObject", "uiGmapLogger", "uiGmapModelKey", function(c, e, f) {
                var g;
                return g = function(c) {
                    function f() {
                        this.watchProps = a(this.watchProps, this), this.buildOpts = a(this.buildOpts, this), this.hasModel = _(this.scope).chain().keys().contains("model").value()
                    }
                    return d(f, c), f.prototype.props = ["clickable", "draggable", "editable", "visible", {
                        prop: "stroke",
                        isColl: !0
                    }], f.prototype.buildOpts = function(a, c) {
                        var d, f, g;
                        return null == a && (a = {}), null == c && (c = {}), this.scope ? this.map ? (d = this.hasModel ? this.scope.model : this.scope, g = this.scopeOrModelVal("stroke", this.scope, d), f = b.extend(a, this.DEFAULTS, {
                            map: this.map,
                            strokeColor: null != g ? g.color : void 0,
                            strokeOpacity: null != g ? g.opacity : void 0,
                            strokeWeight: null != g ? g.weight : void 0
                        }), b.forEach(b.extend(c, {
                            clickable: !0,
                            draggable: !1,
                            editable: !1,
                            "static": !1,
                            ...
                            return function(c, e) {
                                var g;
                                return g = a.scopeOrModelVal(e, a.scope, d), f[e] = b.isUndefined(g) ? c : d[e]
                            }
                        }(this)), f["static"] && (f.editable = !1), f) : void e.error("this.map not defined in CommonOptionsBuilder can not buildOpts") : void e.error("this.scope not defined in CommonOptionsBuilder can not buildOpts")
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api.options.builders").factory("uiGmapPolylineOptionsBuilder", ["uiGmapCommonOptionsBuilder", function(a) {
                var b;
                return b = function(a) {
                    function b() {
                        return b.__super__.constructor.apply(this, arguments)
                    }
                    return c(b, a), b.prototype.buildOpts = function(a) {
                        return b.__super__.buildOpts.call(this, {
                            path: a
                        }, {
                            geodesic: !1
                        })
            ...
            }]).factory("uiGmapShapeOptionsBuilder", ["uiGmapCommonOptionsBuilder", function(a) {
                var d;
                return d = function(a) {
                    function d() {
                        return d.__super__.constructor.apply(this, arguments)
                    }
                    return c(d, a), d.prototype.buildOpts = function(a, c) {
                        var e, f;
                        return f = this.hasModel ? this.scope.model : this.scope, e = this.scopeOrModelVal("fill", this.scope, f), a = b.extend(a, {
                            fillColor: null != e ? e.color : void 0,
                            fillOpacity: null != e ? e.opacity : void 0
                        }), d.__super__.buildOpts.call(this, a, c)
                    }, d
                }(a)
            }]).factory("uiGmapPolygonOptionsBuilder", ["uiGmapShapeOptionsBuilder", function(a) {
                var b;
                return b = function(a) {
                    function b() {
                        return b.__super__.constructor.apply(this, arguments)
            ...
            }]).factory("uiGmapRectangleOptionsBuilder", ["uiGmapShapeOptionsBuilder", function(a) {
                var b;
                return b = function(a) {
                    function b() {
                        return b.__super__.constructor.apply(this, arguments)
            ...
            }]).factory("uiGmapCircleOptionsBuilder", ["uiGmapShapeOptionsBuilder", function(a) {
                var b;
                return b = function(a) {
                    function b() {
                        return b.__super__.constructor.apply(this, arguments)
                    }
                    return c(b, a), b.prototype.buildOpts = function(a, c) {
                        return b.__super__.buildOpts.call(this, {
                            center: a,
                            radius: c
                        })
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapBasePolyChildModel", ["uiGmapLogger", "$timeout", "uiGmaparray-sync", "uiGmapGmapUtil", "uiGmapEventsHelper", function(c, e, f, g, h) {
                return function(c, e) {
                    var i;
                    return i = function(c) {
                        function i(c, d, g, i, j) {
                            ...
                            this.scope = c, this.attrs = d, this.map = g, this.defaults = i, this.model = j, this.clean = a(this.clean, this), this.clonedModel = _.clone(this.model, !0), this.isDragging = !1, this.internalEvents = {
                                ...
                                return function() {
                                    var b;
                                    if (!a.isDragging) return b = a.convertPathPoints(a.scope.path), null != a.shape && a.clean(), b.length > 0 && (a.shape = e(a.buildOpts(b))), a.shape ? (a.scope.fit && a.extendMapBounds(g, b), f(a.shape.getPath(), a.scope, "path", function(b) {
                                        return a.scope.fit ? a.extendMapBounds(g, b) : void 0
                                    }), a.listeners = a.model ? a.setEvents(a.shape, a.scope, a.model) : a.setEvents(a.shape, a.scope, a.scope), a.internalListeners = a.model ? a.setEvents(a.shape, {
                                        events: a.internalEvents
                                    }, a.model) : a.setEvents(a.shape, {
                                        events: a.internalEvents
                                    }, a.scope)) : void 0
                                }
                            }(this), k(), c.$watch("path", function(a) {
                                return function(b, c) {
                                    return _.isEqual(b, c) && a.shape ? void 0 : k()
                                }
                            }(this), !0), !c["static"] && b.isDefined(c.editable) && c.$watch("editable", function(a) {
                                return function(b, c) {
                                    var d;
                                    return b !== c ? (b = !a.isFalse(b), null != (d = a.shape) ? d.setEditable(b) : void 0) : void 0
                                }
                            }(this), !0), b.isDefined(c.draggable) && c.$watch("draggable", function(a) {
                                return function(b, c) {
                                    var d;
                                    return b !== c ? (b = !a.isFalse(b), null != (d = a.shape) ? d.setDraggable(b) : void 0) : void 0
                                }
                            }(this), !0), b.isDefined(c.visible) && c.$watch("visible", function(a) {
                                return function(b, c) {
                                    var d;
                                    return b !== c && (b = !a.isFalse(b)), null != (d = a.shape) ? d.setVisible(b) : void 0
                                }
                            }(this), !0), b.isDefined(c.geodesic) && c.$watch("geodesic", function(a) {
                                return function(b, c) {
                                    var d;
                                    return b !== c ? (b = !a.isFalse(b), null != (d = a.shape) ? d.setOptions(a.buildOpts(a.shape.getPath())) : void 0) : void 0
                                }
                            }(this), !0), b.isDefined(c.stroke) && b.isDefined(c.stroke.weight) && c.$watch("stroke.weight", function(a) {
                                return function(b, c) {
                                    var d;
                                    return b !== c && null != (d = a.shape) ? d.setOptions(a.buildOpts(a.shape.getPath())) : void 0
                                }
                            }(this), !0), b.isDefined(c.stroke) && b.isDefined(c.stroke.color) && c.$watch("stroke.color", function(a) {
                                return function(b, c) {
                                    var d;
                                    return b !== c && null != (d = a.shape) ? d.setOptions(a.buildOpts(a.shape.getPath())) : void 0
                                }
                            }(this), !0), b.isDefined(c.stroke) && b.isDefined(c.stroke.opacity) && c.$watch("stroke.opacity", function(a) {
                                return function(b, c) {
                                    var d;
                                    return b !== c && null != (d = a.shape) ? d.setOptions(a.buildOpts(a.shape.getPath())) : void 0
                                }
                            }(this), !0), b.isDefined(c.icons) && c.$watch("icons", function(a) {
                                return function(b, c) {
                                    var d;
                                    return b !== c && null != (d = a.shape) ? d.setOptions(a.buildOpts(a.shape.getPath())) : void 0
                                }
                            }(this), !0), c.$on("$destroy", function(a) {
                                return function() {
                                    return a.clean(), a.scope = null
                                }
                            }(this)), b.isDefined(c.fill) && b.isDefined(c.fill.color) && c.$watch("fill.color", function(a) {
                                return function(b, c) {
                                    return b !== c ? a.shape.setOptions(a.buildOpts(a.shape.getPath())) : void 0
                                }
                            }(this)), b.isDefined(c.fill) && b.isDefined(c.fill.opacity) && c.$watch("fill.opacity", function(a) {
                                return function(b, c) {
                                    return b !== c ? a.shape.setOptions(a.buildOpts(a.shape.getPath())) : void 0
                                }
                            }(this)), b.isDefined(c.zIndex) && c.$watch("zIndex", function(a) {
                                return function(b, c) {
                                    return b !== c ? a.shape.setOptions(a.buildOpts(a.shape.getPath())) : void 0
                                }
                            }(this)), b.isDefined(c.events) && null !== c.events && b.isObject(c.events) && (this.listeners = h.setEvents(this.shape, c, c))
                        }
                        return d(i, c), i.include(g), i.include(h), i.prototype.clean = function() {
                            var a;
                            return this.removeEvents(this.listeners), this.removeEvents(this.internalListeners), null != (a = this.shape) && a.setMap(null), this.shape = null
                        }, i
                    }(c)
                }
            }])
            ...
            b.module("uiGmapgoogle-maps.directives.api.models.child").factory("uiGmapDrawFreeHandChildModel", ["uiGmapLogger", "$q", function(a, b) {
                ...
                return c = function(a, b, c) {
                    ...
                    return this.map = d, e || (e = {
                        ...
                        return function() {
                            return a.info("disabling map move"), b.oldOptions = d.getOptions(), b.oldOptions.center = d.getCenter(), b.map.setOptions({
                                draggable: !1,
                                zoomControl: !1,
                                scrollwheel: !1,
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api.models.child").factory("uiGmapMarkerChildModel", ["uiGmapModelKey", "uiGmapGmapUtil", "uiGmapLogger", "uiGmapEventsHelper", "uiGmapPropertyAction", "uiGmapMarkerOptions", "uiGmapIMarker", "uiGmapMarkerManager", "uiGmapPromise", function(b, c, e, f, g, h, i, j, k) {
                var l, m;
                return m = ["coords", "icon", "options", "fit"], l = function(b) {
                    function l(b, c, d, f, h, i, j, n, o, p) {
                        var q;
                        this.model = c, this.keys = d, this.gMap = f, this.defaults = h, this.doClick = i, this.gMarkerManager = j, this.doDrawSelf = null != n ? n : !0, this.trackModel = null != o ? o : !0, this.needRedraw = null != p ? p : !1, this.internalEvents = a(this.internalEvents, this), this.setLabelOptions = a(this.setLabelOptions, this), this.setOptions = a(this.setOptions, this), this.setIcon = a(this.setIcon, this), this.setCoords = a(this.setCoords, this), this.isNotValid = a(this.isNotValid, this), this.maybeSetScopeValue = a(this.maybeSetScopeValue, this), this.createMarker = a(this.createMarker, this), this.setMyScope = a(this.setMyScope, this), this.updateModel = a(this.updateModel, this), this.handleModelChanges = a(this.handleModelChanges, this), this.destroy = a(this.destroy, this), this.clonedModel = _.clone(this.model, !0), this.deferred = k.defer(), _.each(this.keys, function(a) {
                            return function(b, c) {
                    ...
                    var m;
                    return d(l, b), l.include(c), l.include(f), l.include(h), m = function(a) {
                        ...
                        return this.cloneModel = _.clone(a, !0), this.setMyScope("all", a, this.model)
                        ...
                        if (null == a && (a = !0), c = this.getProp(this.coordsKey, this.model), null != c) {
                            ...
                            if (null != b && b(), a && this.gMarker) return this.gMarkerManager.add(this.gMarker)
                        } else if (a && this.gMarker) return this.gMarkerManager.remove(this.gMarker)
                    }, l.prototype.setMyScope = function(a, b, c, d, e) {
                        var f;
                        switch (null == c && (c = void 0), null == d && (d = !1), null == e && (e = !0), null == b ? b = this.model : this.model = b, this.gMarker || (this.setOptions(this.scope, e), f = !0), a) {
                            case "all":
                        ...
                        return null == g && (g = void 0), null == h && (h = !0), null != g && g(this.scope, h), this.doDrawSelf && h ? this.gMarkerManager.draw() : void 0
                    }, l.prototype.isNotValid = function(a, b) {
                        var c, d;
                        return null == b && (b = !0), d = b ? void 0 === this.gMarker : !1, c = this.trackModel ? !1 : a.$id !== this.scope.$id, c || d
                    }, l.prototype.setCoords = function(a, b) {
                        return null == b && (b = !0), this.isNotValid(a) || null == this.gMarker ? void 0 : this.renderGMarker(b, function(a) {
                            return function() {
                                var b, c, d;
                                return c = a.getProp(a.coordsKey, a.model), b = a.getCoords(c), d = a.gMarker.getPosition(), null == d || null == b || b.lng() !== d.lng() || b.lat() !== d.lat() ? (a.gMarker.setPosition(b), a.gMarker.setVisible(a.validateCoords(c))) : void 0
                            }
                        }(this))
                        ...
                        return null == b && (b = !0), this.isNotValid(a) || null == this.gMarker ? void 0 : this.renderGMarker(b, function(a) {
                            return function() {
                                var b, c, d;
                                return d = a.gMarker.getIcon(), c = a.getProp("icon", a.model), d !== c ? (a.gMarker.setIcon(c), b = a.getProp("coords", a.model), a.gMarker.setPosition(a.getCoords(b)), a.gMarker.setVisible(a.validateCoords(b))) : void 0
                            }
                        }(this))
                            ...
                            if (this.renderGMarker(b, function(a) {
                                    return function() {
                                        ...
                                        return b = a.getProp(a.coordsKey, a.model), c = a.getProp(a.iconKey, a.model), d = a.getProp(a.optionsKey, a.model), a.opts = a.createOptions(b, c, d), null != a.gMarker && a.gMarker.setOptions(a.opts), a.gMarker || (a.gMarker = a.isLabel(a.opts) ? new MarkerWithLabel(a.setLabelOptions(a.opts)) : new google.maps.Marker(a.opts), _.extend(a.gMarker, {
                                            model: a.model
                                        })), a.externalListeners && a.removeEvents(a.externalListeners), a.internalListeners && a.removeEvents(a.internalListeners), a.externalListeners = a.setEvents(a.gMarker, a.scope, a.model, ["dragend"]), a.internalListeners = a.setEvents(a.gMarker, {
                                            events: a.internalEvents(),
                                            $evalAsync: function() {}
                                        }, a.model), null != a.id ? a.gMarker.key = a.id : void 0
                                    }
                                }(this)), this.gMarker && (this.gMarker.getMap() || this.gMarkerManager.type !== j.type)) this.deferred.resolve(this.gMarker);
                            else {
                                if (!this.gMarker) return this.deferred.reject("gMarker is null");
                                (null != (c = this.gMarker) ? c.getMap() : 0) && this.gMarkerManager.type === j.type || (e.debug("gMarker has no map yet"), this.deferred.resolve(this.gMarker))
                            }
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapPolygonChildModel", ["uiGmapBasePolyChildModel", "uiGmapPolygonOptionsBuilder", function(a, b) {
                var d, e, f;
                return f = function(a) {
                    return new google.maps.Polygon(a)
                }, e = new a(b, f), d = function(a) {
                    function b() {
                        return b.__super__.constructor.apply(this, arguments)
                    }
                    return c(b, a), b
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapPolylineChildModel", ["uiGmapBasePolyChildModel", "uiGmapPolylineOptionsBuilder", function(a, b) {
                var d, e, f;
                return f = function(a) {
                    return new google.maps.Polyline(a)
                }, e = a(b, f), d = function(a) {
                    function b() {
                        return b.__super__.constructor.apply(this, arguments)
                    }
                    return c(b, a), b
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api.models.child").factory("uiGmapWindowChildModel", ["uiGmapBaseObject", "uiGmapGmapUtil", "uiGmapLogger", "$compile", "$http", "$templateCache", "uiGmapChromeFixes", "uiGmapEventsHelper", function(d, f, g, h, i, j, k, l) {
                var m;
                return m = function(d) {
                    ...
                    return e(m, d), m.include(f), m.include(l), m.prototype.doShow = function() {
                        ...
                        var b, c;
                        if (null != this.gWin) return c = this.getGmarker(), b = function(a) {
                            return function() {
                                return null == a.gWin && a.createGWin(), a.showWindow(), null != c ? (a.initialMarkerVisibility = c.getVisible(), a.oldMarkerAnimation = c.getAnimation(), c.setVisible(a.isIconVisibleOnClick)) : void 0
                            }
                        ...
                        var a, c, d;
                        return null != this.gWin ? (c = function(a) {
                            return function() {
                                var b, c, d;
                                if (!a.gWin.isOpen()) {
                                    if (c = a.getGmarker(), null != a.gWin && null != a.gWin.getPosition && (d = a.gWin.getPosition()), c && (d = c.getPosition()), !d) return;
                                    if (a.gWin.open(a.mapCtrl, c), b = a.gWin.isOpen(), a.model.show !== b) return a.model.show = b
                                }
                            }
                            ...
                            return function(d) {
                                var e, f;
                                return f = a.scope.$new(), b.isDefined(a.scope.templateParameter) && (f.parameter = a.scope.templateParameter), e = h(d.data)(f), a.gWin.setContent(e[0]), c()
                            }
                        }(this)) : this.scope.template ? (d = this.scope.$new(), b.isDefined(this.scope.templateParameter) && (d.parameter = this.scope.templateParameter), a = h(this.scope.template)(d), this.gWin.setContent(a[0]), c()) : c()) : void 0
                        ...
                        var b;
                        return b = this.getGmarker(), null == this.gWin || null == b || a ? a ? this.gWin.setPosition(a) : void 0 : this.gWin.setPosition(b.getPosition())
                    }, m.prototype.remove = function() {
                        return this.hideWindow(), this.removeEvents(this.listeners), this.listeners.length = 0, delete this.gWin, delete this.opts
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapCircleParentModel", ["uiGmapLogger", "$timeout", "uiGmapGmapUtil", "uiGmapEventsHelper", "uiGmapCircleOptionsBuilder", function(a, d, e, f, g) {
                var h;
                return h = function(d) {
                    function g(c, d, f, g, h) {
                        var i, j;
                        this.scope = c, this.attrs = f, this.map = g, this.DEFAULTS = h, i = new google.maps.Circle(this.buildOpts(e.getCoords(c.center), c.radius)), this.setMyOptions = function(a) {
                            return function(b, d) {
                                return _.isEqual(b, d) ? void 0 : i.setOptions(a.buildOpts(e.getCoords(c.center), c.radius))
                            }
                            ...
                            prop: "fill",
                            isColl: !0
                        }, "radius"]), this.watchProps(), j = this.setEvents(i, c, c), google.maps.event.addListener(i, "radius_changed", function() {
                            return c.$evalAsync(function() {
                                return c.radius = i.getRadius()
                            })
                        }), google.maps.event.addListener(i, "center_changed", function() {
                            return c.$evalAsync(function() {
                                return b.isDefined(c.center.type) ? (c.center.coordinates[1] = i.getCenter().lat(), c.center.coordinates[0] = i.getCenter().lng()) : (c.center.latitude = i.getCenter().lat(), c.center.longitude = i.getCenter().lng())
                            })
                    ...
                    return c(g, d), g.include(e), g.include(f), g
                }(g)
            }])
        }.call(this),
        function() {
            b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapDrawingManagerParentModel", ["uiGmapLogger", "$timeout", function() {
                var a;
                return a = function() {
                    function a(a, b, c, d) {
                        var e;
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapIMarkerParentModel", ["uiGmapModelKey", "uiGmapLogger", function(c, e) {
                var f;
                return f = function(c) {
                    function f(c, d, g, h) {
                        if (this.scope = c, this.element = d, this.attrs = g, this.map = h, this.onDestroy = a(this.onDestroy, this), this.onWatch = a(this.onWatch, this), this.watch = a(this.watch, this), this.validateScope = a(this.validateScope, this), f.__super__.constructor.call(this, this.scope), this.$log = e, !this.validateScope(c)) throw new String("Unable to construct IMarkerParentModel due to invalid scope");
                        this.doClick = b.isDefined(g.click), null != c.options && (this.DEFAULTS = c.options), this.watch("coords", this.scope), this.watch("icon", this.scope), this.watch("options", this.scope), c.$on("$destroy", function(a) {
                            return function() {
                                return a.onDestroy(c)
                            }
                        }(this))
                    }
                    return d(f, c), f.prototype.DEFAULTS = {}, f.prototype.validateScope = function(a) {
                        var b;
                    ...
                    }, f.prototype.onWatch = function() {}, f.prototype.onDestroy = function() {
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapIWindowParentModel", ["uiGmapModelKey", "uiGmapGmapUtil", "uiGmapLogger", function(a, b, d) {
                var e;
                return e = function(a) {
                    ...
                    return c(e, a), e.include(b), e.prototype.getItem = function(a, b, c) {
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapLayerParentModel", ["uiGmapBaseObject", "uiGmapLogger", "$timeout", function(c, e) {
                var f;
                return f = function(c) {
                    function f(c, d, f, g, h, i) {
                        return this.scope = c, this.element = d, this.attrs = f, this.gMap = g, this.onLayerCreated = null != h ? h : void 0, this.$log = null != i ? i : e, this.createGoogleLayer = a(this.createGoogleLayer, this), null == this.attrs.type ? void this.$log.info("type attribute for the layer directive is mandatory. Layer creation aborted!!") : (this.createGoogleLayer(), this.doShow = !0, b.isDefined(this.attrs.show) && (this.doShow = this.scope.show), this.doShow && null != this.gMap && this.layer.setMap(this.gMap), this.scope.$watch("show", function(a) {
                            return function(b, c) {
                    ...
                    return d(f, c), f.prototype.createGoogleLayer = function() {
                        var a;
                        return this.layer = null == this.attrs.options ? void 0 === this.attrs.namespace ? new google.maps[this.attrs.type] : new google.maps[this.attrs.namespace][this.attrs.type] : void 0 === this.attrs.namespace ? new google.maps[this.attrs.type](this.scope.options) : new google.maps[this.attrs.namespace][this.attrs.type](this.scope.options), null != this.layer && null != this.onLayerCreated && "function" == typeof(a = this.onLayerCreated(this.scope, this.layer)) ? a(this.layer) : void 0
                    }, f
                }(c)
            }])
        }.call(this),
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapMapTypeParentModel", ["uiGmapBaseObject", "uiGmapLogger", function(c, e) {
                var f;
                return f = function(c) {
                    ...
                    return d(f, c), f.prototype.createMapType = function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapMarkersParentModel", ["uiGmapIMarkerParentModel", "uiGmapModelsWatcher", "uiGmapPropMap", "uiGmapMarkerChildModel", "uiGmap_async", "uiGmapClustererMarkerManager", "uiGmapMarkerManager", "$timeout", "uiGmapIMarker", "uiGmapPromise", "uiGmapGmapUtil", "uiGmapLogger", function(c, e, f, g, h, i, j, k, l, m, n) {
                ...
                return o = function(c) {
                    function k(b, c, d, e) {
                        ...
                        var g;
                        k.__super__.constructor.call(this, b, c, d, e), g = this, this.scope.markerModels = new f, this.scope.markerModelsUpdate = {
                            updateCtr: 0
                        }, this.$log.info(this), this.doRebuildAll = null != this.scope.doRebuildAll ? this.scope.doRebuildAll : !1, this.setIdKey(b), this.scope.$watch("doRebuildAll", function(a) {
                            return function(b, c) {
                                return b !== c ? a.doRebuildAll = b : void 0
                            }
                        }(this)), (null == b.models || 0 === b.models.length) && (this.modelsRendered = !1), this.scope.$watch("models", function(a) {
                            return function(c, d) {
                                if (!_.isEqual(c, d) || !a.modelsRendered) {
                                    if (0 === c.length && 0 === d.length) return;
                                    return a.modelsRendered = !0, a.onWatch("models", b, c, d)
                                }
                            }
                        }(this), !this.isTrue(d.modelsbyref)), this.watch("doCluster", b), this.watch("clusterOptions", b), this.watch("clusterEvents", b), this.watch("fit", b), this.watch("idKey", b), this.gMarkerManager = void 0, this.createMarkersFromScratch(b)
                    }
                    return d(k, c), k.include(n), k.include(e), k.prototype.onWatch = function(a, b, c, d) {
                    ...
                    }, k.prototype.createMarkersFromScratch = function(a) {
                        var b;
                        ...
                        }(this))()), this.gMarkerManager || (this.gMarkerManager = new i(this.map, void 0, a.clusterOptions, this.clusterInternalOptions))), this.gMarkerManager || (this.gMarkerManager = new j(this.map)), this.gMarkerManager.clear(), this.didQueueInitPromise(this, a) ? void 0 : (b = null, h.promiseLock(this, m.promiseTypes.create, "createAllNew", function(a) {
                            return b = a
                        }, function(c) {
                            return function() {
                                return h.each(a.models, function(d) {
                                    return c.newChildMarker(d, a), b
                                }, h.chunkSizeFrom(a.chunk)).then(function() {
                                    return c.modelsRendered = !0, c.gMarkerManager.draw(), a.fit && c.gMarkerManager.fit(), c.scope.markerModelsUpdate.updateCtr += 1
                                }, h.chunkSizeFrom(a.chunk))
                            }
                        }(this)))
                    }, k.prototype.reBuildMarkers = function(a) {
                        var b;
                        if (a.doRebuild || void 0 === a.doRebuild) return (null != (b = this.scope.markerModels) ? b.length : void 0) ? this.onDestroy(a).then(function(b) {
                            return function() {
                                return b.createMarkersFromScratch(a)
                            }
                        }(this)) : this.createMarkersFromScratch(a)
                    }, k.prototype.pieceMeal = function(a) {
                        var b, c;
                        if (!a.$$destroyed) return b = null, c = null, null != this.scope.models && this.scope.models.length > 0 && this.scope.markerModels.length > 0 ? h.promiseLock(this, m.promiseTypes.update, "pieceMeal", function(a) {
                            return b = a
                        }, function(d) {
                            return function() {
                                return m.promise(function() {
                                    return d.figureOutState(d.idKey, a, d.scope.markerModels, d.modelKeyComparison)
                                }).then(function(e) {
                                    return c = e, h.each(c.removals, function(a) {
                                        return null != a ? (null != a.destroy && a.destroy(), d.scope.markerModels.remove(a.id), b) : void 0
                                    }, h.chunkSizeFrom(a.chunk))
                                }).then(function() {
                                    ...
                                    return (c.adds.length > 0 || c.removals.length > 0 || c.updates.length > 0) && (d.gMarkerManager.draw(), a.markerModels = d.scope.markerModels, a.fit && d.gMarkerManager.fit()), d.scope.markerModelsUpdate.updateCtr += 1
                                })
                            }
                        }(this)) : (this.inProgress = !1, this.reBuildMarkers(a))
                    }, k.prototype.updateChild = function(a, b) {
                        return null == b[this.idKey] ? void this.$log.error("Marker model has no id to assign a child to. This is required for performance. Please assign id, or redirect id to a different key.") : a.updateModel(b)
                    }, k.prototype.newChildMarker = function(a, b) {
                        var c, d, e, f;
                        return null == a[this.idKey] ? void this.$log.error("Marker model has no id to assign a child to. This is required for performance. Please assign id, or redirect id to a different key.") : (this.$log.info("child", c, "markers", this.scope.markerModels), d = b.$new(!0), d.events = b.events, f = {}, _.each(l.scopeKeys, function(a, c) {
                            return f[c] = b[c]
                        }), c = new g(d, a, f, this.map, this.DEFAULTS, this.doClick, this.gMarkerManager, e = !1), this.scope.markerModels.put(a[this.idKey], c), c)
                    }, k.prototype.onDestroy = function() {
                        return h.promiseLock(this, m.promiseTypes["delete"], void 0, void 0, function(a) {
                            return function() {
                                return h.each(a.scope.markerModels.values(), function(a) {
                                    return null != a ? a.destroy(!1) : void 0
                                }, !1).then(function() {
                                    return delete a.scope.markerModels, null != a.gMarkerManager && a.gMarkerManager.clear(), a.scope.markerModels = new f, a.scope.markerModelsUpdate.updateCtr += 1
                                })
                            }
                        }(this))
                    ...
                    }, k.prototype.mapClusterToMarkerModels = function(a) {
                        var b;
                        return b = a.getMarkers().map(function(a) {
                            return function(b) {
                                return a.scope.markerModels.get(b.key).model
                            }
                        }(this)), {
                            cluster: a,
                            mapped: b
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapPolygonsParentModel", ["$timeout", "uiGmapLogger", "uiGmapModelKey", "uiGmapModelsWatcher", "uiGmapPropMap", "uiGmapPolygonChildModel", "uiGmap_async", "uiGmapPromise", function(c, e, f, g, h, i, j, k) {
                var l;
                return l = function(c) {
                    function f(b, c, d, g, i) {
                        var j;
                        this.scope = b, this.element = c, this.attrs = d, this.gMap = g, this.defaults = i, this.modelKeyComparison = a(this.modelKeyComparison, this), this.createChild = a(this.createChild, this), this.pieceMeal = a(this.pieceMeal, this), this.createAllNew = a(this.createAllNew, this), this.watchIdKey = a(this.watchIdKey, this), this.createChildScopes = a(this.createChildScopes, this), this.watchOurScope = a(this.watchOurScope, this), this.watchDestroy = a(this.watchDestroy, this), this.onDestroy = a(this.onDestroy, this), this.rebuildAll = a(this.rebuildAll, this), this.doINeedToWipe = a(this.doINeedToWipe, this), this.watchModels = a(this.watchModels, this), this.watch = a(this.watch, this), f.__super__.constructor.call(this, b), j = this, this.$log = e, this.plurals = new h, this.scopePropNames = ["path", "stroke", "clickable", "draggable", "editable", "geodesic", "icons", "visible"], _.each(this.scopePropNames, function(a) {
                            return function(b) {
                    ...
                    return d(f, c), f.include(g), f.prototype.watch = function(a, b, c) {
                        return a.$watch(b, function(d) {
                            return function(e, f) {
                                var g;
                                return e !== f ? (g = null, d[c] = _.isFunction(e) ? e() : e, j.promiseLock(d, k.promiseTypes.update, "watch " + b + " " + c, function(a) {
                                    return g = a
                                }, function() {
                                    return j.each(d.plurals.values(), function(a) {
                                        return a.scope[b] = "self" === d[c] ? a : a[d[c]], g
                                    }, j.chunkSizeFrom(a.chunk))
                                })) : void 0
                            }
                        }(this))
                    }, f.prototype.watchModels = function(a) {
                        return a.$watchCollection("models", function(b) {
                            return function(c, d) {
                                return !_.isEqual(c, d) || b.lastNewValue === c && b.lastOldValue === d ? (b.lastNewValue = c, b.lastOldValue = d, b.doINeedToWipe(c) ? b.rebuildAll(a, !0, !0) : b.createChildScopes(!1)) : void 0
                            }
                        }(this))
                    }, f.prototype.doINeedToWipe = function(a) {
                        var b;
                        return b = null != a ? 0 === a.length : !0, this.plurals.length > 0 && b
                    }, f.prototype.rebuildAll = function(a, b, c) {
                        ...
                        return j.promiseLock(this, k.promiseTypes["delete"], void 0, void 0, function(b) {
                            return function() {
                                return j.each(b.plurals.values(), function(a) {
                                    return a.destroy(!0)
                                }, !1).then(function() {
                                    return a && delete b.plurals, b.plurals = new h
                                })
                            }
                        }(this))
                    }, f.prototype.watchDestroy = function(a) {
                        return a.$on("$destroy", function(b) {
                            return function() {
                                return b.rebuildAll(a, !1, !0)
                            }
                        }(this))
                    }, f.prototype.watchOurScope = function(a) {
                    ...
                    }, f.prototype.createChildScopes = function(a) {
                        return null == a && (a = !0), b.isUndefined(this.scope.models) ? void this.$log.error("No models to create Polygons from! I Need direct models!") : null != this.gMap && null != this.scope.models ? (this.watchIdKey(this.scope), a ? this.createAllNew(this.scope, !1) : this.pieceMeal(this.scope, !1)) : void 0
                    }, f.prototype.watchIdKey = function(a) {
                        return this.setIdKey(a), a.$watch("idKey", function(b) {
                            return function(c, d) {
                                return c !== d && null == c ? (b.idKey = c, b.rebuildAll(a, !0, !0)) : void 0
                            }
                        }(this))
                    }, f.prototype.createAllNew = function(a, b) {
                        var c;
                        return null == b && (b = !1), this.models = a.models, this.firstTime && (this.watchModels(a), this.watchDestroy(a)), this.didQueueInitPromise(this, a) ? void 0 : (c = null, j.promiseLock(this, k.promiseTypes.create, "createAllNew", function(a) {
                            return c = a
                        }, function(b) {
                            return function() {
                                return j.each(a.models, function(a) {
                                    var d;
                    ...
                    }, f.prototype.pieceMeal = function(a, b) {
                        var c, d;
                        return null == b && (b = !0), a.$$destroyed ? void 0 : (c = null, d = null, this.models = a.models, null != a && null != a.models && a.models.length > 0 && this.plurals.length > 0 ? j.promiseLock(this, k.promiseTypes.update, "pieceMeal", function(a) {
                            return c = a
                        }, function(b) {
                            return function() {
                                return k.promise(function() {
                                    ...
                                    return d = e, j.each(d.removals, function(a) {
                                        var d;
                                        return d = b.plurals.get(a), null != d ? (d.destroy(), b.plurals.remove(a), c) : void 0
                                    }, j.chunkSizeFrom(a.chunk))
                                }).then(function() {
                                    return j.each(d.adds, function(a) {
                    ...
                    }, f.prototype.createChild = function(a, b) {
                        var c, d;
                        return d = this.scope.$new(!1), this.setChildScope(this.scopePropNames, d, a), d.$watch("model", function(a) {
                            return function(b, c) {
                                return b !== c ? a.setChildScope(d, b) : void 0
                            }
                        }(this), !0), d["static"] = this.scope["static"], c = new i(d, this.attrs, b, this.defaults, a), null == a[this.idKey] ? void this.$log.error("Polygon model has no id to assign a child to.\nThis is required for performance. Please assign id,\nor redirect id to a different key.") : (this.plurals.put(a[this.idKey], c), c)
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapPolylinesParentModel", ["$timeout", "uiGmapLogger", "uiGmapModelKey", "uiGmapModelsWatcher", "uiGmapPropMap", "uiGmapPolylineChildModel", "uiGmap_async", "uiGmapPromise", function(c, e, f, g, h, i, j, k) {
                var l;
                return l = function(c) {
                    function f(b, c, d, g, i) {
                        var j;
                    ...
                    return d(f, c), f.include(g), f.prototype.watch = function(a, b, c) {
                        return a.$watch(b, function(a) {
                            return function(d, e) {
                                var f;
                                return d !== e ? (f = null, a[c] = _.isFunction(d) ? d() : d, j.promiseLock(a, k.promiseTypes.update, "watch " + b + " " + c, function(a) {
                                    return f = a
                                }, function() {
                                    return j.each(a.plurals.values(), function(d) {
                                        return d.scope[b] = "self" === a[c] ? d : d[a[c]], f
                                    }, !1)
                                })) : void 0
                            }
                        }(this))
                        ...
                        return null == a && (a = !0), b.isUndefined(this.scope.models) ? void this.$log.error("No models to create Polylines from! I Need direct models!") : null != this.gMap && null != this.scope.models ? (this.watchIdKey(this.scope), a ? this.createAllNew(this.scope, !1) : this.pieceMeal(this.scope, !1)) : void 0
                    }, f.prototype.watchIdKey = function(a) {
                        return this.setIdKey(a), a.$watch("idKey", function(b) {
                            return function(c, d) {
                                return c !== d && null == c ? (b.idKey = c, b.rebuildAll(a, !0, !0)) : void 0
                        ...
                        return null == b && (b = !1), this.models = a.models, this.firstTime && (this.watchModels(a), this.watchDestroy(a)), this.didQueueInitPromise(this, a) ? void 0 : (c = null, j.promiseLock(this, k.promiseTypes.create, "createAllNew", function(a) {
                            ...
                            return function() {
                                return j.each(a.models, function(a) {
                                    return b.createChild(a, b.gMap), c && e.debug("createNew should fall through safely"), c
                                }).then(function() {
                                    return b.firstTime = !1
                                })
                            }
                        ...
                        return null == b && (b = !0), a.$$destroyed ? void 0 : (c = null, d = null, this.models = a.models, null != a && null != a.models && a.models.length > 0 && this.plurals.length > 0 ? j.promiseLock(this, k.promiseTypes.update, "pieceMeal", function(a) {
                            ...
                            return function() {
                                return k.promise(function() {
                                    ...
                                    return d = a, j.each(d.removals, function(a) {
                                        var d;
                                        return d = b.plurals.get(a), null != d ? (d.destroy(), b.plurals.remove(a), c) : void 0
                                    })
                                }).then(function() {
                        ...
                        }(this), !0), d["static"] = this.scope["static"], c = new i(d, this.attrs, b, this.defaults, a), null == a[this.idKey] ? void this.$log.error("Polyline model has no id to assign a child to.\nThis is required for performance. Please assign id,\nor redirect id to a different key.") : (this.plurals.put(a[this.idKey], c), c)
                    }, f.prototype.setChildScope = function(a, b) {
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapRectangleParentModel", ["uiGmapLogger", "uiGmapGmapUtil", "uiGmapEventsHelper", "uiGmapRectangleOptionsBuilder", function(a, b, d, e) {
                var f;
                return f = function(e) {
                    function f(b, c, d, e, f) {
                        ...
                        this.scope = b, this.attrs = d, this.map = e, this.DEFAULTS = f, g = void 0, j = !1, n = [], m = void 0, k = function(a) {
                            ...
                            return function() {
                                var a, c, d;
                                return a = o.getBounds(), c = a.getNorthEast(), d = a.getSouthWest(), p ? void 0 : b.$evalAsync(function(b) {
                    ...
                    return c(f, e), f.include(b), f.include(d), f
                }(e)
            }])
        }.call(this),
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapSearchBoxParentModel", ["uiGmapBaseObject", "uiGmapLogger", "uiGmapEventsHelper", "$timeout", "$http", "$templateCache", function(c, e, f) {
                var g;
                return g = function(c) {
                    ...
                    return d(g, c), g.include(f), g.prototype.init = function() {
                        ...
                        }(this), !0), null != this.attrs.parentdiv ? this.addToParentDiv() : this.addAsMapControl(), this.listener = google.maps.event.addListener(this.searchBox, "places_changed", function(a) {
                            return function() {
                                return a.places = a.searchBox.getPlaces()
                            }
                        }(this)), this.listeners = this.setEvents(this.searchBox, this.scope, this.scope), this.$log.info(this), this.scope.$on("$destroy", function(a) {
                            return function() {
                        ...
                        else if (a.isEmpty() === !1 && null != this.searchBox) return this.searchBox.setBounds(a)
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapWindowsParentModel", ["uiGmapIWindowParentModel", "uiGmapModelsWatcher", "uiGmapPropMap", "uiGmapWindowChildModel", "uiGmapLinked", "uiGmap_async", "uiGmapLogger", "$timeout", "$compile", "$http", "$templateCache", "$interpolate", "uiGmapPromise", function(c, e, f, g, h, i, j, k, l, m, n, o, p) {
                ...
                return q = function(c) {
                    ...
                    }, q.prototype.watchModels = function(a) {
                        var b;
                        return b = null != this.markersScope ? "markerModelsUpdate" : "models", a.$watch(b, function(b) {
                            return function(c, d) {
                                var e;
                                return !_.isEqual(c, d) || b.firstWatchModels ? (b.firstWatchModels = !1, b.doRebuildAll || b.doINeedToWipe(a.models) ? b.rebuildAll(a, !0, !0) : (e = 0 === b.windows.length, null != b.existingPieces ? _.last(b.existingPieces._content).then(function() {
                                    return b.createChildScopesWindows(e)
                                }) : b.createChildScopesWindows(e))) : void 0
                            }
                        }(this), !0)
                    }, q.prototype.doINeedToWipe = function(a) {
                        var b;
                        return b = null != a ? 0 === a.length : !0, this.windows.length > 0 && b
                    }, q.prototype.rebuildAll = function(a, b, c) {
                        return this.onDestroy(c).then(function(a) {
                            return function() {
                                return b ? a.createChildScopesWindows() : void 0
                            }
                        }(this))
                    }, q.prototype.onDestroy = function(a) {
                        return i.promiseLock(this, p.promiseTypes["delete"], void 0, void 0, function(b) {
                            return function() {
                                return i.each(b.windows.values(), function(a) {
                                    return a.destroy()
                                }, !1).then(function() {
                                    return a && delete b.windows, b.windows = new f
                                })
                            }
                        }(this))
                    }, q.prototype.watchDestroy = function(a) {
                        return a.$on("$destroy", function(b) {
                            return function() {
                                return b.firstWatchModels = !0, b.firstTime = !0, b.rebuildAll(a, !1, !0)
                            }
                        }(this))
                    }, q.prototype.watchOurScope = function(a) {
                        return _.each(this.scopePropNames, function(b) {
                            return function(c) {
                                var d;
                    ...
                    }, q.prototype.createChildScopesWindows = function(a) {
                        var c, d, e;
                        return null == a && (a = !0), this.isIconVisibleOnClick = !0, b.isDefined(this.linked.attrs.isiconvisibleonclick) && (this.isIconVisibleOnClick = this.linked.scope.isIconVisibleOnClick), c = b.isUndefined(this.linked.scope.models), !c || void 0 !== this.markersScope && void 0 !== (null != (d = this.markersScope) ? d.markerModels : void 0) && void 0 !== (null != (e = this.markersScope) ? e.models : void 0) ? null != this.gMap ? null != this.linked.scope.models ? (this.watchIdKey(this.linked.scope), a ? this.createAllNewWindows(this.linked.scope, !1) : this.pieceMealWindows(this.linked.scope, !1)) : (this.parentScope = this.markersScope, this.watchIdKey(this.parentScope), a ? this.createAllNewWindows(this.markersScope, !0, "markerModels", !1) : this.pieceMealWindows(this.markersScope, !0, "markerModels", !1)) : void 0 : void this.$log.error("No models to create windows from! Need direct models or models derived from markers!")
                    }, q.prototype.watchIdKey = function(a) {
                        return this.setIdKey(a), a.$watch("idKey", function(b) {
                            return function(c, d) {
                                return c !== d && null == c ? (b.idKey = c, b.rebuildAll(a, !0, !0)) : void 0
                            }
                        }(this))
                    }, q.prototype.createAllNewWindows = function(a, b, c, d) {
                        var e;
                        return null == c && (c = "models"), null == d && (d = !1), this.models = a.models, this.firstTime && (this.watchModels(a), this.watchDestroy(a)), this.setContentKeys(a.models), this.didQueueInitPromise(this, a) ? void 0 : (e = null, i.promiseLock(this, p.promiseTypes.create, "createAllNewWindows", function(a) {
                            return e = a
                        }, function(d) {
                            return function() {
                                return i.each(a.models, function(f) {
                                    var g, h;
                                    return g = b && null != (h = d.getItem(a, c, f[d.idKey])) ? h.gMarker : void 0, e || (!g && d.markersScope && j.error("Unable to get gMarker from markersScope!"), d.createWindow(f, g, d.gMap)), e
                                }, i.chunkSizeFrom(a.chunk)).then(function() {
                                    return d.firstTime = !1
                                })
                            }
                        }(this)))
                    }, q.prototype.pieceMealWindows = function(a, b, c, d) {
                        var e, f;
                        return null == c && (c = "models"), null == d && (d = !0), a.$$destroyed ? void 0 : (e = null, f = null, this.models = a.models, null != a && null != a.models && a.models.length > 0 && this.windows.length > 0 ? i.promiseLock(this, p.promiseTypes.update, "pieceMeal", function(a) {
                            return e = a
                        }, function(b) {
                            return function() {
                                return p.promise(function() {
                                    return b.figureOutState(b.idKey, a, b.windows, b.modelKeyComparison)
                                }).then(function(c) {
                                    return f = c, i.each(f.removals, function(a) {
                                        return null != a ? (b.windows.remove(a.id), null != a.destroy && a.destroy(!0), e) : void 0
                                    }, i.chunkSizeFrom(a.chunk))
                                }).then(function() {
                                    return i.each(f.adds, function(d) {
                                        var f, g;
                                        if (f = null != (g = b.getItem(a, c, d[b.idKey])) ? g.gMarker : void 0, !f) throw "Gmarker undefined";
                                        return b.createWindow(d, f, b.gMap), e
                                    })
                                })
                            }
                        }(this)) : (j.debug("pieceMealWindows: rebuildAll"), this.rebuildAll(this.scope, !0, !0)))
                    }, q.prototype.setContentKeys = function(a) {
                        return a.length > 0 ? this.contentKeys = Object.keys(a[0]) : void 0
                    }, q.prototype.createWindow = function(a, b, c) {
                        var d, e, f, h, i, j;
                    ...
                    }, q.prototype.setChildScope = function(a, b) {
                        return _.each(this.scopePropNames, function(c) {
                            return function(d) {
                                var e, f;
                                return e = d + "Key", f = "self" === c[e] ? b : b[c[e]], f !== a[d] ? a[d] = f : void 0
                    ...
                    }, q.prototype.interpolateContent = function(a, b) {
                        var c, d, e, f, g, h;
                        if (void 0 !== this.contentKeys && 0 !== this.contentKeys.length) {
                            for (c = o(a), d = {}, h = this.contentKeys, f = 0, g = h.length; g > f; f++) e = h[f], d[e] = b[e];
                            return c(d)
                        }
                    }, q
                }(c)
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapControl", ["uiGmapIControl", "$http", "$templateCache", "$compile", "$controller", "uiGmapGoogleMapApi", function(c, e, f, g, h, i) {
                var j;
                return j = function(j) {
                    function k() {
                        this.link = a(this.link, this), k.__super__.constructor.call(this)
                    }
                    return d(k, j), k.prototype.link = function(a, d, j, k) {
                        return i.then(function(d) {
                            return function(i) {
                                var j, l;
                                return b.isUndefined(a.template) ? void d.$log.error("mapControl: could not find a valid template property") : (j = b.isDefined(a.index && !isNaN(parseInt(a.index))) ? parseInt(a.index) : void 0, l = b.isDefined(a.position) ? a.position.toUpperCase().replace(/-/g, "_") : "TOP_CENTER", i.ControlPosition[l] ? c.mapPromise(a, k).then(function(c) {
                                    var i, k;
                                    return i = void 0, k = b.element("<div></div>"), e.get(a.template, {
                                        ...
                                        return d.$log.error("mapControl: template could not be found")
                                    }).then(function() {
                                        return c.controls[google.maps.ControlPosition[l]].push(i[0])
                                    })
                                }) : void d.$log.error("mapControl: invalid position property"))
                            }
                        }(this))
                    }, k
                }(c)
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapApiFreeDrawPolygons", ["uiGmapLogger", "uiGmapBaseObject", "uiGmapCtrlHandle", "uiGmapDrawFreeHandChildModel", "uiGmapLodash", function(b, c, e, f, g) {
                var h;
                return h = function(c) {
                    function h() {
                        return this.link = a(this.link, this), h.__super__.constructor.apply(this, arguments)
                    }
                    return d(h, c), h.include(e), h.prototype.restrict = "EMA", h.prototype.replace = !0, h.prototype.require = "^uiGmapGoogleMap", h.prototype.scope = {
                        polygons: "=",
                        draw: "=",
                        revertmapoptions: "="
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapIControl", ["uiGmapBaseObject", "uiGmapLogger", "uiGmapCtrlHandle", function(a, b, d) {
                var e;
                return e = function(a) {
                    function e() {
                    ...
                    return c(e, a), e.extend(d), e.prototype.link = function() {
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapIMarker", ["uiGmapBaseObject", "uiGmapCtrlHandle", function(a, b) {
                var d;
                return d = function(a) {
                    function d() {
                        this.restrict = "EMA", this.require = "^uiGmapGoogleMap", this.priority = -1, this.transclude = !0, this.replace = !0, this.scope = _.extend(this.scope || {}, d.scopeKeys)
                    }
                    return c(d, a), d.scopeKeys = {
                        coords: "=coords",
                        icon: "=icon",
                        click: "&click",
                        options: "=options",
                        ...
                        idKey: "=idkey",
                        control: "=control"
                    }, d.keys = _.keys(d.scopeKeys), d.extend(b), d
                }(a)
            }])
        }.call(this),
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapIPolygon", ["uiGmapGmapUtil", "uiGmapBaseObject", "uiGmapLogger", "uiGmapCtrlHandle", function(a, b, d, e) {
                var f;
                return f = function(b) {
                    function f() {}
                    return c(f, b), f.include(a), f.extend(e), f.prototype.restrict = "EMA", f.prototype.replace = !0, f.prototype.require = "^uiGmapGoogleMap", f.prototype.scope = {
                        path: "=path",
                        stroke: "=stroke",
                        clickable: "=",
                        draggable: "=",
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapIPolyline", ["uiGmapGmapUtil", "uiGmapBaseObject", "uiGmapLogger", "uiGmapCtrlHandle", function(a, b, d, e) {
                var f;
                return f = function(b) {
                    function f() {}
                    return c(f, b), f.include(a), f.extend(e), f.prototype.restrict = "EMA", f.prototype.replace = !0, f.prototype.require = "^uiGmapGoogleMap", f.prototype.scope = {
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapIWindow", ["uiGmapBaseObject", "uiGmapChildEvents", "uiGmapCtrlHandle", function(a, b, d) {
                var e;
                return e = function(a) {
                    function e() {
                        this.restrict = "EMA", this.template = void 0, this.transclude = !0, this.priority = -100, this.require = "^uiGmapGoogleMap", this.replace = !0, this.scope = {
                            coords: "=coords",
                            template: "=template",
                    ...
                    return c(e, a), e.include(b), e.extend(d), e
                }(a)
            }])
        }.call(this),
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapMap", ["$timeout", "$q", "uiGmapLogger", "uiGmapGmapUtil", "uiGmapBaseObject", "uiGmapCtrlHandle", "uiGmapIsReady", "uiGmapuuid", "uiGmapExtendGWin", "uiGmapExtendMarkerClusterer", "uiGmapGoogleMapsUtilV3", "uiGmapGoogleMapApi", "uiGmapEventsHelper", function(d, f, g, h, i, j, k, l, m, n, o, p, q) {
                var r, s, t;
                return r = void 0, t = [o, m, n], s = function(f) {
                    ...
                    return e(i, f), i.include(h), i.prototype.restrict = "EMA", i.prototype.transclude = !0, i.prototype.replace = !1, i.prototype.template = '<div class="angular-google-map"><div class="angular-google-map-container"></div><div ng-transclude style="display: none"></div></div>', i.prototype.scope = {
                        center: "=",
                        zoom: "=",
                        dragging: "=",
                        control: "=",
                        ...
                        bounds: "=",
                        update: "="
                    }, i.prototype.link = function(a, e, f) {
                        var h, i;
                        return h = [], a.$on("$destroy", function() {
                            ...
                            return function() {
                                return a.center ? (i(), b.link(a, e, f)) : void 0
                            }
                        }(this))) : p.then(function(i) {
                            return function(j) {
                                var m, n, o, p, s, t, u, v, w, x, y, z, A, B, C, D, E, F;
                                if (r = {
                                        mapTypeId: j.MapTypeId.ROADMAP
                                    }, C = k.spawn(), x = function() {
                                ...
                                if (p = b.element(e), p.addClass("angular-google-map"), w = {
                                        options: {}
                                    }, f.options && (w.options = a.options), f.styles && (w.styles = a.styles), f.type && (D = f.type.toUpperCase(), google.maps.MapTypeId.hasOwnProperty(D) ? w.mapTypeId = google.maps.MapTypeId[f.type.toUpperCase()] : g.error("angular-google-maps: invalid map type '" + f.type + "'")), u = b.extend({}, r, w, {
                                        center: i.getCoords(a.center),
                                        zoom: a.zoom,
                                        bounds: a.bounds
                                    }), E = new google.maps.Map(p.find("div")[1], u), E.uiGmap_id = l.generate(), o = !1, h.push(google.maps.event.addListenerOnce(E, "idle", function() {
                                        return a.deferred.resolve(E), x()
                                    })), n = f.events && null != (null != (F = a.events) ? F.blacklist : void 0) ? a.events.blacklist : [], _.isString(n) && (n = [n]), v = function(b, c, d) {
                                        return _.contains(n, b) ? void 0 : (d && d(), h.push(google.maps.event.addListener(E, b, function() {
                                            var b;
                                            return (null != (b = a.update) ? b.lazy : void 0) ? void 0 : c()
                                        })))
                                    }, _.contains(n, "all") || (v("dragstart", function() {
                                        ...
                                        var c, e, f, g;
                                        return c = E.center, d(function() {
                                            var d;
                                            return d = a, b.isDefined(d.center.type) ? (d.center.coordinates[1] = c.lat(), d.center.coordinates[0] = c.lng()) : (d.center.latitude = c.lat(), d.center.longitude = c.lng())
                                        }, null != (e = a.eventOpts) && null != (f = e.debounce) && null != (g = f.debounce) ? g.dragMs : void 0)
                                    }), B = !1, A = !1, v("zoom_changed", function() {
                                        var b, c;
                                        if (!B) return a.zoom !== E.zoom ? (A = !0, d(function() {
                                            return a.zoom = E.zoom, A = !1
                                        }, null != (b = a.eventOpts) && null != (c = b.debounce) ? c.zoomMs : void 0)) : void 0
                                    }), z = !1, y = !1, v("center_changed", function() {
                                        var c, e, f;
                                        return c = E.center, z ? void 0 : (y = !0, d(function() {
                                            var d;
                                            return d = a, E.dragging || (b.isDefined(d.center.type) ? (d.center.coordinates[1] !== c.lat() && (d.center.coordinates[1] = c.lat()), d.center.coordinates[0] !== c.lng() && (d.center.coordinates[0] = c.lng())) : (d.center.latitude !== c.lat() && (d.center.latitude = c.lat()), d.center.longitude !== c.lng() && (d.center.longitude = c.lng()))), y = !1
                                        }, null != (e = a.eventOpts) && null != (f = e.debounce) ? f.centerMs : void 0))
                                    }), v("idle", function() {
                                        var d, e, f;
                                        return d = E.getBounds(), e = d.getNorthEast(), f = d.getSouthWest(), a.$evalAsync(function(d) {
                                            var g;
                                            return g = E.center, b.isDefined(d.center.type) ? (d.center.coordinates[1] !== g.lat() && (d.center.coordinates[1] = g.lat()), d.center.coordinates[0] !== g.lng() && (d.center.coordinates[0] = g.lng())) : (d.center.latitude !== g.lat() && (d.center.latitude = g.lat()), d.center.longitude !== g.lng() && (d.center.longitude = g.lng())), null !== d.bounds && d.bounds !== c && void 0 !== d.bounds ? (d.bounds.northeast = {
                                                latitude: e.lat(),
                                                longitude: e.lng()
                                            }, d.bounds.southwest = {
                                                latitude: f.lat(),
                                                longitude: f.lng()
                                            }, d.zoom = E.zoom, a.idleAndZoomChanged = !a.idleAndZoomChanged) : void 0
                                        })
                                    })), b.isDefined(a.events) && null !== a.events && b.isObject(a.events)) {
                                    t = function(b) {
                                        return function() {
                                            return a.events[b].apply(a, [E, b, arguments])
                                        }
                                    }, m = [];
                                    for (s in a.events) a.events.hasOwnProperty(s) && b.isFunction(a.events[s]) && m.push(google.maps.event.addListener(E, s, t(s)));
                                    h.concat(m)
                                }
                                return E.getOptions = function() {
                                    return u
                                }, a.map = E, null != f.control && null != a.control && (a.control.refresh = function(a) {
                                    var b;
                                    if (null != E) return google.maps.event.trigger(E, "resize"), null != (null != a ? a.latitude : void 0) && null != (null != a ? a.latitude : void 0) ? (b = i.getCoords(a), i.isTrue(f.pan) ? E.panTo(b) : E.setCenter(b)) : void 0
                                    ...
                                    var d;
                                    if (b !== c && !y && (d = i.getCoords(a.center), d.lat() !== E.center.lat() || d.lng() !== E.center.lng())) return z = !0, o || (i.validateCoords(b) || g.error("Invalid center for newValue: " + JSON.stringify(b)), i.isTrue(f.pan) && a.zoom === E.zoom ? E.panTo(d) : E.setCenter(d)), z = !1
                                }, !0), a.$watch("zoom", function(b, c) {
                                    var e, f;
                                    if (!_.isEqual(b, c) && E.getZoom() !== a.zoom) return B = !0, d(function() {
                                        return E.setZoom(b), B = !1
                                    }, (null != (e = a.eventOpts) && null != (f = e.debounce) ? f.zoomMs : void 0) + 20, !1)
                                }), a.$watch("bounds", function(a, b) {
                                    var c, d, e;
                                    if (a !== b) return null == a.northeast.latitude || null == a.northeast.longitude || null == a.southwest.latitude || null == a.southwest.longitude ? void g.error("Invalid map bounds for new value: " + JSON.stringify(a)) : (d = new google.maps.LatLng(a.northeast.latitude, a.northeast.longitude), e = new google.maps.LatLng(a.southwest.latitude, a.southwest.longitude), c = new google.maps.LatLngBounds(e, d), E.fitBounds(c))
                                }), ["options", "styles"].forEach(function(b) {
                                    return a.$watch(b, function(a, b) {
                                        var c;
                                        return c = this.exp, _.isEqual(a, b) ? void 0 : (w.options = a, null != E ? E.setOptions(w) : void 0)
                                    })
                                }, !0)
                            }
                        }(this))
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapMarker", ["uiGmapIMarker", "uiGmapMarkerChildModel", "uiGmapMarkerManager", "uiGmapLogger", function(b, c, e, f) {
                var g;
                return g = function(g) {
                    function h() {
                    ...
                    return d(h, g), h.prototype.controller = ["$scope", "$element", function(a, c) {
                        return a.ctrlType = "Marker", _.extend(this, b.handle(a, c))
                    }], h.prototype.link = function(a, d, f, g) {
                        var h;
                        return h = b.mapPromise(a, g), h.then(function() {
                            return function(d) {
                                var f, g, h, i, j, k;
                                return h = new e(d), i = _.object(b.keys, b.keys), j = new c(a, a, i, d, {}, f = !0, h, g = !1, k = !1), j.deferred.promise.then(function(b) {
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapMarkers", ["uiGmapIMarker", "uiGmapPlural", "uiGmapMarkersParentModel", "uiGmap_sync", "uiGmapLogger", function(a, b, d, e, f) {
                var g;
                return g = function(e) {
                    function g() {
                        g.__super__.constructor.call(this), this.template = '<span class="angular-google-map-markers" ng-transclude></span>', b.extend(this, {
                    ...
                    return c(g, e), g.prototype.controller = ["$scope", "$element", function(b, c) {
                        return b.ctrlType = "Markers", _.extend(this, a.handle(b, c))
                    }], g.prototype.link = function(b, c, e, f) {
                        var g, h;
                        return g = void 0, h = function() {
                            return null != b.control && (b.control.getGMarkers = function() {
                                var a;
                                return null != (a = g.gMarkerManager) ? a.getGMarkers() : void 0
                            }, b.control.getChildMarkers = function() {
                                return g.markerModels
                            }), b.deferred.resolve()
                        }, a.mapPromise(b, f).then(function(a) {
                            var i;
                            return i = f.getScope(), i.$watch("idleAndZoomChanged", function() {
                                return _.defer(g.gMarkerManager.draw)
                            }), g = new d(b, c, e, a), _.last(g.existingPieces._content).then(function() {
                                return h()
                            })
                        })
                    }, g
        ...
        function() {
            b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapPlural", [function() {
                return {
                    extend: function(a, b) {
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapPolygon", ["uiGmapIPolygon", "$timeout", "uiGmaparray-sync", "uiGmapPolygonChildModel", function(b, c, e, f) {
                var g;
                return g = function(c) {
                    function e() {
                        return this.link = a(this.link, this), e.__super__.constructor.apply(this, arguments)
                    }
                    return d(e, c), e.prototype.link = function(a, c, d, e) {
                        var g, h;
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapPolygons", ["uiGmapIPolygon", "$timeout", "uiGmaparray-sync", "uiGmapPolygonsParentModel", "uiGmapPlural", function(c, e, f, g, h) {
                var i;
                return i = function(c) {
                    function e() {
                    ...
                    return d(e, c), e.prototype.link = function(a, c, d, e) {
                        return e.getScope().deferred.promise.then(function(e) {
                            return function(f) {
                                var h;
                                return (b.isUndefined(a.path) || null === a.path) && e.$log.warn("polygons: no valid path attribute found"), a.models || e.$log.warn("polygons: no models found to create from"), h = null, null != a.control && (a.control.updateModels = function(b) {
                                    return a.models = b, h.createChildScopes(!1)
                                }, a.control.newModels = function(b) {
                                    return a.models = b, h.rebuildAll(a, !0, !0)
                                }, a.control.clean = function() {
                                    return h.rebuildAll(a, !1, !0)
                                }), h = new g(a, c, d, f, e.DEFAULTS)
                            }
                        }(this))
                    }, e
                }(c)
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapPolyline", ["uiGmapIPolyline", "$timeout", "uiGmaparray-sync", "uiGmapPolylineChildModel", function(c, e, f, g) {
                var h;
                return h = function(e) {
                    function f() {
                        return this.link = a(this.link, this), f.__super__.constructor.apply(this, arguments)
                    }
                    return d(f, e), f.prototype.link = function(a, d, e, f) {
                        return c.mapPromise(a, f).then(function(c) {
                            return function(d) {
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapPolylines", ["uiGmapIPolyline", "$timeout", "uiGmaparray-sync", "uiGmapPolylinesParentModel", function(c, e, f, g) {
                var h;
                return h = function(c) {
                    function e() {
                    ...
                    return d(e, c), e.prototype.link = function(a, c, d, e) {
                        return e.getScope().deferred.promise.then(function(e) {
                            return function(f) {
                                return (b.isUndefined(a.path) || null === a.path) && e.$log.warn("polylines: no valid path attribute found"), a.models || e.$log.warn("polylines: no models found to create from"), new g(a, c, d, f, e.DEFAULTS)
                            }
                        }(this))
                    }, e
                }(c)
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapWindow", ["uiGmapIWindow", "uiGmapGmapUtil", "uiGmapWindowChildModel", "uiGmapLodash", "uiGmapLogger", function(c, e, f, g, h) {
                var i;
                return i = function(i) {
                    function j() {
                    ...
                    return d(j, i), j.include(e), j.prototype.link = function(a, d, e, f) {
                        var g, h;
                        return g = f.length > 1 && null != f[1] ? f[1] : void 0, h = null != g ? g.getScope() : void 0, this.mapPromise = c.mapPromise(a, f[0]), this.mapPromise.then(function(c) {
                            return function(f) {
                                var i;
                                return i = !0, b.isDefined(e.isiconvisibleonclick) && (i = a.isIconVisibleOnClick), g ? h.deferred.promise.then(function() {
                                    return c.init(a, d, i, f, h)
                                }) : void c.init(a, d, i, f)
                            }
                        }(this))
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapWindows", ["uiGmapIWindow", "uiGmapPlural", "uiGmapWindowsParentModel", "uiGmapPromise", "uiGmapLogger", function(b, c, e, f, g) {
                var h;
                return h = function(b) {
                    function h() {
                        this.init = a(this.init, this), this.link = a(this.link, this), h.__super__.constructor.call(this), this.require = ["^uiGmapGoogleMap", "^?uiGmapMarkers"], this.template = '<span class="angular-google-maps-windows" ng-transclude></span>', c.extend(this), g.debug(this)
                    }
                    return d(h, b), h.prototype.link = function(a, b, c, d) {
                        var e, g, h;
                    ...
                    }, h.prototype.init = function(a, b, c, d, f, g) {
                        var h;
                        return h = new e(a, b, c, d, f, g), null != a.control ? (a.control.getGWindows = function() {
                            return function() {
        ...
        function() {
            ...
            b.module("uiGmapgoogle-maps").directive("uiGmapSearchBox", ["uiGmapGoogleMapApi", "uiGmapLogger", "uiGmapSearchBoxParentModel", "$http", "$templateCache", "$compile", function(c, d, e, f, g, h) {
                ...
                return new(i = function() {
                    ...
                    return i.prototype.link = function(a, d, i, j) {
        ...
        }]), b.module("uiGmapgoogle-maps.extensions").service("uiGmapExtendMarkerClusterer", ["uiGmapLodash", function(b) {
            return {
                init: _.once(function() {
                    (function() {
                        ...
                        a.NgMapCluster = function(c) {
                            function e(b) {
                                e.__super__.constructor.call(this, b), this.markers_ = new a.PropMap
                            }
                            return d(e, c), e.prototype.addMarker = function(a) {
                                var b, c;
                        ...
                        }(Cluster), a.NgMapMarkerClusterer = function(b) {
                            function c(b, d, e) {
                                c.__super__.constructor.call(this, b, d, e), this.markers_ = new a.PropMap
                            }
                            return d(c, b), c.prototype.clearMarkers = function() {
